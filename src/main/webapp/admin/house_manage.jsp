    ...
    <div data-v-166a34a6 class="order-manager m-view">
        	<div class="main-operate">
					...
					<ul data-v-1b1fd10f="" class="right search-box">
        				...
        				<div data-v-1b1fd10f="" class="ivu-input-wrapper ivu-input-type" style="width: 200px;"><!----> 
            				<i class="ivu-icon ivu-icon-ios-search ivu-input-icon ivu-input-icon-normal"></i> <!----> 
           					<input autocomplete="off" spellcheck="false" type="text" placeholder="房屋编号" class="ivu-input"></div>&nbsp;&nbsp;
				...
				<div align="center" id="houselst" style="width:100%;">
               	 ...
               	 <table style="border:#999;width:100%;margin-top:10px;display:block;" id="houselst" border="1" cellspacing="2" align="center">
                 	<thead style="height:35px;">
                    <tr bgcolor="#CCCCCC">
                        <th height="32" style="width: 7%">房屋编号</th>
                        <th style="width: 12%">所属商户</th>
                        <th style="width: 10%">房屋名称</th>
                 	...
                 	<c:forEach items="${requestScope.houselst}" var="house">
		                   <tr align="center" style="height:35px;">
		                        <td>${house.hid}</td>
		                        <td>${house.user.uname}(${house.user.tel})</td>
		                        ...
		                        <td>
		                        	...
		                        	<c:if test="${house.isdel==0}">
		                        		<c:if test="${house.state==0}">
			                        		<a href="javascript:;" onclick="passhouse('${house.hid}')">通过审批</a>
			                        		<a href="javascript:;" onclick="nopasshouse('${house.hid}')">不通过</a>
			                        	</c:if>
			                        	<c:if test="${house.state==1}">
		                        	...
		                        	<c:if test="${house.isdel==1}">
		                        		<a href="javascript:;" onclick="uphouse('${house.hid}')">重新上架房屋</a>
		                        	</c:if>
		                        </td>
		                   </tr>
                   </c:forEach>
